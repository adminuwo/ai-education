              ...
              <CardHeader>
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-400 mt-0.5">One last step</p>
                  </div>
                </div>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="rounded-xl border border-cyan-500/25 bg-cyan-500/10 p-4 text-sm text-slate-200">
                ...
                <Button className="w-full font-semibold border-slate-700 bg-slate-800 hover:bg-slate-700 text-white" onClick={resend} disabled={resendLoading} variant="outline">
        ...
        <div className="w-full max-w-md relative z-10">
          ...
          <Card className="w-full border-slate-800/90 bg-slate-900/80 backdrop-blur-xl shadow-2xl shadow-cyan-950/30">
            <CardHeader>
              ...
              <p className="text-sm text-slate-400">You will be the Director of your institution.</p>
            </CardHeader>
            <CardContent>
              ...
              <div className="my-5 flex items-center gap-3"><div className="h-px flex-1 bg-slate-800" /><span className="text-xs text-slate-500">OR</span><div className="h-px flex-1 bg-slate-800" /></div>
              <Button variant="outline" className="w-full border-slate-800 bg-slate-950/40 hover:bg-slate-800 text-slate-200" onClick={startGoogle} data-testid="register-google-button">
              ...
              <div className="mt-6 text-center text-sm text-slate-400">Already have an account? <Link to="/login" className="font-medium text-cyan-400 hover:underline">Sign in</Link></div>
            </CardContent>
          </Card>
        </div>
      </div>
