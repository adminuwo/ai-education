...
export default function RegisterPage() {
  ...
  const BrandPanel = () => (
    <div className="relative hidden lg:flex flex-col justify-between p-12 bg-[hsl(var(--sidebar))] overflow-hidden">
      ...
      <div className="relative z-10 font-display text-2xl font-semibold flex items-center gap-3">
        <img src="/logo192.png" alt="Convee Education Logo" className="h-9 w-9 object-contain rounded-md" />
      ...
      <div className="grid min-h-screen grid-cols-1 lg:grid-cols-2 bg-background">
        ...
        <div className="flex items-center justify-center p-6 sm:p-10">
          <div className="w-full max-w-md">
            <div className="lg:hidden flex items-center justify-center gap-2.5 font-display text-2xl font-semibold mb-6">
          ...
          <Card className="w-full border-border shadow-md">
            ...
            <CardContent>
              <form onSubmit={submit} className="space-y-4">
                ...
                <Button type="submit" className="w-full font-semibold" disabled={loading} data-testid="register-submit-button">{loading ? 'Creating…' : 'Create account'}</Button>
              </form>
