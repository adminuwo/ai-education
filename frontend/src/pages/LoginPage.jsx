...
export default function LoginPage({ initialPortal = 'faculty' }) {
  ...
  const BrandPanel = () => (
    <div className="relative hidden lg:flex flex-col justify-between p-12 bg-[#060913] text-white overflow-hidden border-r border-slate-800/80">
      ...
      <div className="relative z-10 max-w-lg">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-cyan-500/10 border border-cyan-500/25 text-cyan-300 text-xs font-medium mb-6 backdrop-blur-sm">
          <Sparkles className="h-3.5 w-3.5 text-cyan-400 animate-pulse" />
          <span>AI-Powered Academic Intelligence</span>
        </div>

        <h1 className="font-display text-4xl xl:text-5xl font-bold tracking-tight leading-[1.15] text-balance text-white">
        ...
        <div className="mt-8 space-y-3">
          <div className="flex items-center gap-3.5 p-3 rounded-xl bg-slate-900/50 border border-slate-800/80 backdrop-blur-sm">
            <div className="h-9 w-9 rounded-lg bg-cyan-500/15 border border-cyan-500/30 flex items-center justify-center text-cyan-400 shrink-0">
              <Building2 className="h-5 w-5" />
            </div>
            <div className="text-sm">
              <span className="font-semibold text-slate-200 block">School Wings & Class Section Management</span>
              <span className="text-xs text-slate-400">Playschool, Primary, Middle, Secondary & Senior Secondary hierarchy</span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3.5 p-3 rounded-xl bg-slate-900/50 border border-slate-800/80 backdrop-blur-sm">
            ...
            <div className="text-sm">
              <span className="font-semibold text-slate-200 block">Dedicated Student Directory & Secure Access</span>
              <span className="text-xs text-slate-400">Direct admission ID access, automated homework tracking, and attendance</span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3.5 p-3 rounded-xl bg-slate-900/50 border border-slate-800/80 backdrop-blur-sm">
            ...
            <div className="text-sm">
              <span className="font-semibold text-slate-200 block">Faculty & Staff Hierarchy</span>
              <span className="text-xs text-slate-400">Director, Principal, Dean, HOD & Teacher class-level permissions</span>
            </div>
          </div>

          <div className="flex items-center gap-3.5 p-3 rounded-xl bg-slate-900/50 border border-slate-800/80 backdrop-blur-sm">
            <div className="h-9 w-9 rounded-lg bg-purple-500/15 border border-purple-500/30 flex items-center justify-center text-purple-400 shrink-0">
              <ShieldCheck className="h-5 w-5" />
            </div>
            <div className="text-sm">
              <span className="font-semibold text-slate-200 block">Role-based Access & Campus Security</span>
              <span className="text-xs text-slate-400">Class assignment controls with encrypted data segregation</span>
            </div>
          </div>
        </div>
      </div>

      <div className="relative z-10 flex items-center justify-between text-xs text-slate-500 border-t border-slate-800/80 pt-4">
  ...
  if (view === 'unverified') {
    return (
      <div className="grid min-h-screen grid-cols-1 lg:grid-cols-2 bg-[#070B14]">
        <BrandPanel />
        <div className="relative flex items-center justify-center p-6 sm:p-10 bg-[#070B14] overflow-hidden min-h-screen">
            ...
            <Card className="w-full border-slate-800/90 bg-slate-900/80 backdrop-blur-xl shadow-2xl shadow-cyan-950/30">
              <CardHeader>
                <div className="flex items-center gap-3 mb-2">
                  <div className="h-12 w-12 rounded-full bg-amber-500/15 border border-amber-500/30 flex items-center justify-center">
                    <Mail className="h-6 w-6 text-amber-400" />
                  </div>
                  <div>
                    <CardTitle className="font-display text-xl text-white">Verify your email</CardTitle>
                    <p className="text-sm text-slate-400 mt-0.5">Check your inbox to continue</p>
                  </div>
                </div>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <Button className="w-full font-semibold border-slate-700 bg-slate-800 hover:bg-slate-700 text-white" onClick={resendVerification} disabled={resendLoading} variant="outline">
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 text-sm text-slate-400 hover:text-cyan-400 transition-colors w-full justify-center"
                >
            ...
            <Card className="w-full border-slate-800/90 bg-slate-900/80 backdrop-blur-xl shadow-2xl shadow-cyan-950/30">
              ...
              <CardContent>
                ...
                <button
                  type="button"
                  onClick={() => setView('login')}
                  className="flex items-center gap-1.5 text-sm text-slate-400 hover:text-cyan-400 transition-colors w-full justify-center mt-4"
                >
                  <ArrowLeft className="h-4 w-4" /> Back to login
                </button>
              </CardContent>
        ...
        <div className="relative flex items-center justify-center p-6 sm:p-10 bg-[#070B14] overflow-hidden min-h-screen">
          ...
          <div className="w-full max-w-md relative z-10">
            ...
            <Card className="w-full border-slate-800/90 bg-slate-900/80 backdrop-blur-xl shadow-2xl shadow-cyan-950/30">
              <CardHeader>
                <div className="flex items-center gap-3 mb-2">
                  <div className="h-12 w-12 rounded-full bg-cyan-500/15 border border-cyan-500/30 flex items-center justify-center">
                    <Mail className="h-6 w-6 text-cyan-400" />
                  </div>
                  <div>
                    <CardTitle className="font-display text-xl text-white">Check your inbox</CardTitle>
                    <p className="text-sm text-slate-400 mt-0.5">Reset link sent</p>
                  </div>
                </div>
              </CardHeader>
              <CardContent className="space-y-4">
        ...
        <div className="w-full max-w-md relative z-10">
          ...
          <Card className="w-full border-slate-800/90 bg-slate-900/80 backdrop-blur-xl shadow-2xl shadow-cyan-950/30">
            <CardHeader className="pb-4">
              {/* Mode Switcher Tabs */}
              <div className="grid grid-cols-3 gap-1.5 p-1 bg-slate-950/80 rounded-xl border border-slate-800 mb-4">
                <button
                  type="button"
              ...
              {portalMode === 'faculty' ? (
                <div>
                  <CardTitle className="font-display text-2xl flex items-center gap-2 text-white">
                    <UserCheck className="h-5 w-5 text-blue-400" /> Faculty & Staff Sign In
                  </CardTitle>
                  <p className="text-sm text-slate-400 mt-1">Sign in with your institutional credentials.</p>
                </div>
              ) : portalMode === 'student' ? (
                <div>
                  <CardTitle className="font-display text-2xl flex items-center gap-2 text-white">
                  ...
                  <p className="text-sm text-slate-400 mt-1">Access your class channels, assignments, and campus updates.</p>
                </div>
              ) : (
                <div>
                  <CardTitle className="font-display text-2xl flex items-center gap-2 text-white">
                  ...
                  <p className="text-sm text-slate-400 mt-1">View attendance records, homework rubrics, and message teachers.</p>
                </div>
              )}
            </CardHeader>
            ...
            <CardContent className="space-y-4">
              <form onSubmit={submit} className="space-y-4">
                ...
                <Button
                  type="submit"
                  className="w-full font-semibold py-2.5 bg-gradient-to-r from-cyan-500 via-sky-500 to-indigo-600 hover:from-cyan-400 hover:via-sky-400 hover:to-indigo-500 text-white shadow-lg shadow-cyan-500/25 hover:shadow-cyan-500/40 transition-all border-0"
                  disabled={loading}
              ...
              {portalMode === 'faculty' ? (
                <>
                  <div className="my-4 flex items-center gap-3"><div className="h-px flex-1 bg-slate-800" /><span className="text-xs text-slate-500">OR</span><div className="h-px flex-1 bg-slate-800" /></div>
                  <Button variant="outline" className="w-full border-slate-800 bg-slate-950/40 hover:bg-slate-800 text-slate-200" onClick={startGoogle} data-testid="login-google-button">
                ...
                /* Student Notice Box */
                <div className="mt-4 p-3 rounded-xl border border-cyan-500/25 bg-cyan-500/10 text-xs text-cyan-300 space-y-1">
                ...
                /* Parent Notice Box */
                <div className="mt-4 p-3 rounded-xl border border-purple-500/25 bg-purple-500/10 text-xs text-purple-300 space-y-1">
