        ...
        <ScrollView contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled">
          ...
          <View style={[styles.card, { backgroundColor: colors.card, borderColor: colors.border }]}>
            <Text style={[styles.cardHeading, { color: colors.text }]}>
              {portalMode === 'faculty'
                ? t('auth.portalModeFaculty', 'Faculty & Staff Sign In')
                : portalMode === 'student'
                ? t('auth.portalModeStudent', 'Student Portal Sign In')
                : t('auth.portalModeParent', 'Parent Portal Sign In')}
            </Text>
            ...
            <View style={styles.inputGroup}>
              <Text style={[styles.inputLabel, { color: colors.textSecondary }]}>
                {portalMode === 'student'
                  ...
                  : t('auth.emailLabel', 'Institutional Email')}
              </Text>
